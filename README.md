...
Spatial statistical models (kriging, SAR/SEM) for environmental pollution risk assessment. ISFA TER 2025/2026
...
## Notions de isotropie, anisotropie, variogramme, stationnarité, noyaux de covariance, kernel, kriging a intégrer dans le TER
